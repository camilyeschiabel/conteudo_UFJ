/******************************************************************************
EXERCÍCIO 02 - Escreva um programa em C que solicite ao usuario as dimensoes N x M
de duas matrizes A e B, leia os valores das matrizes do teclado e, em seguida, 
calcule e exiba a matriz C, onde cada elemento de C é a multiplicação dos elementos 
...
int main()
{
    ...
    printf("A multiplicação dessas matrizes é igual à matriz:\n");
